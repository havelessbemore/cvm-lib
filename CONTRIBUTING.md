...
- Search through [issues](https://github.com/havelessbemore/cvm/issues) for bugs you can help fix.
- Look at [discussions/ideas](https://github.com/havelessbemore/cvm/discussions/categories/ideas) for an idea you'd like to explore.
...
- Perform a [quick search](https://github.com/havelessbemore/cvm/issues) to see if the issue has already been reported. If it has and it's still open, add a comment instead of opening a new issue.
...
- Perform a [quick search](https://github.com/havelessbemore/cvm/discussions/categories/ideas) to see if the idea is already suggested.
